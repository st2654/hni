...
insert into activation_codes values('MTIzNDU2', 123456, 2, 10, 10, 0, 29, now(), null);
insert into activation_codes values('OTg3NjU0', 987654, 2, 10, 10, 1, 'freddy has activated this', now(), 2);
